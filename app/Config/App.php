...
class App extends BaseConfig
{
     ...
     */
    public string $sessionCookieName = '_darak_session';
     ...
     */
    public string $cookiePrefix = 'darak';
     ...
     */
    public string $CSRFTokenName = '_darak_csrf';
     ...
     */
    public string $CSRFCookieName = '_darak_csrf_cookie';
